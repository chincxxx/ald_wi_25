var jsPsychSketchpad = (function (jspsych) {
    ...
    class SketchpadPlugin {
        constructor(jsPsych) {
            ...
            this.drawing_started = false; //added March25th
            this.trial_duration_timeout = null;
        }
        ...
        start_draw(e) {
            ...
            this.drawing_started = true; //added March 25th
            //added March 25th
            if (this.trial_duration_timeout !== null) {
                this.jsPsych.pluginAPI.clearTimeout(this.trial_duration_timeout);
                this.trial_duration_timeout = null;
              }
        ...
        set_trial_duration_timer() {
            if (this.params.trial_duration !== null) {
                this.trial_duration_timeout = this.jsPsych.pluginAPI.setTimeout(() => {
                    //this.end_trial(); March25th
                    if (!this.drawing_started) {
                        this.end_trial("timeout");
                      }
        ...
        after_key_response(info) {
            ...
            /*const rt = performance.now() - this.start_time;
            if (rt >= 5000) {
                this.end_trial(info.key);*/
    }
